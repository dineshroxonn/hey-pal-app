...
const Hero = () => {
  ...
  const stats = [
    { icon: TrendingUp, label: '40% Corruption Rate', value: 'Official' },
    { icon: Users, label: '1.4B Audience', value: 'Captive' },
    { icon: Zap, label: '₹40PCT Token', value: 'Your Ticket' },
  ];

  return (
    <section id="show" className="min-h-screen bg-gradient-to-b from-black via-red-950 to-black relative overflow-hidden pt-20">
      {/* Background Effects */}
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          ...
          {/* Key Message */}
          <div className="bg-gradient-to-r from-red-900/80 to-red-800/80 border-4 border-yellow-400 rounded-lg p-8 mb-12 backdrop-blur-sm">
            <h2 className="text-3xl md:text-4xl circus-title text-yellow-400 mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="bg-gradient-to-b from-yellow-400/20 to-red-600/20 border-2 border-yellow-400/50 rounded-lg p-6 backdrop-blur-sm hover:scale-105 transition-transform duration-300">
